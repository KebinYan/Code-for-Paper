...
# training 
# load data
acc_front_walk <- read.csv("~/Desktop/csv/subject1/training/walk/acc_front.csv")
acc_front_stand <- read.csv("~/Desktop/csv/subject1/training/stand/acc_front.csv")
acc_front_stairUp <- read.csv("~/Desktop/csv/subject1/training/stairUp/acc_front.csv")
acc_front_stairDown <- read.csv("~/Desktop/csv/subject1/training/stairDown/acc_front.csv")
acc_front_chairStand1 <- read.csv("~/Desktop/csv/subject1/training/chairStand1/acc_front.csv")
...
# test
# load data
test_acc_front_step1 <- read.csv("~/Desktop/csv/subject1/test/Step1/acc_front.csv")
test_acc_front_step2 <- read.csv("~/Desktop/csv/subject1/test/Step2/acc_front.csv")
test_acc_front_step3_fastWalk <- read.csv("~/Desktop/csv/subject1/test/Step3/fast_walk/acc_front.csv")
test_acc_front_step3_normalWalk <- read.csv("~/Desktop/csv/subject1/test/Step3/normal_walk/acc_front.csv")
test_acc_front_step3_slowWalk <- read.csv("~/Desktop/csv/subject1/test/Step3/slow_walk/acc_front.csv")
test_acc_front_step5 <- read.csv("~/Desktop/csv/subject1/test/Step5/acc_front.csv")
test_acc_front_step6_stairDown <- read.csv("~/Desktop/csv/subject1/test/Step6/stairDown/acc_front.csv")
test_acc_front_step6_stairUp <- read.csv("~/Desktop/csv/subject1/test/Step6/stairUp/acc_front.csv")
...
# training
# load data
gyro_front_walk <- read.csv("~/Desktop/csv/subject1/training/walk/gyro_front.csv")
gyro_front_stand <- read.csv("~/Desktop/csv/subject1/training/stand/gyro_front.csv")
gyro_front_stairUp <- read.csv("~/Desktop/csv/subject1/training/stairUp/gyro_front.csv")
gyro_front_stairDown <- read.csv("~/Desktop/csv/subject1/training/stairDown/gyro_front.csv")
gyro_front_chairStand1 <- read.csv("~/Desktop/csv/subject1/training/chairStand1/gyro_front.csv")
...
# test
# load data
test_gyro_front_step1 <- read.csv("~/Desktop/csv/subject1/test/Step1/gyro_front.csv")
test_gyro_front_step2 <- read.csv("~/Desktop/csv/subject1/test/Step2/gyro_front.csv")
test_gyro_front_step3_fastWalk <- read.csv("~/Desktop/csv/subject1/test/Step3/fast_walk/gyro_front.csv")
test_gyro_front_step3_normalWalk <- read.csv("~/Desktop/csv/subject1/test/Step3/normal_walk/gyro_front.csv")
test_gyro_front_step3_slowWalk <- read.csv("~/Desktop/csv/subject1/test/Step3/slow_walk/gyro_front.csv")
test_gyro_front_step5 <- read.csv("~/Desktop/csv/subject1/test/Step5/gyro_front.csv")
test_gyro_front_step6_stairDown <- read.csv("~/Desktop/csv/subject1/test/Step6/stairDown/gyro_front.csv")
test_gyro_front_step6_stairUp <- read.csv("~/Desktop/csv/subject1/test/Step6/stairUp/gyro_front.csv")
...
write.csv(combined_walk, "~/Desktop/csv/subject1/training/combined/walk_front.csv")
write.csv(combined_stand, "~/Desktop/csv/subject1/training/combined/stand_front.csv")
write.csv(combined_stairUp, "~/Desktop/csv/subject1/training/combined/stairUp_front.csv")
write.csv(combined_stairDown, "~/Desktop/csv/subject1/training/combined/stairDown_front.csv")
write.csv(combined_chairStand1, "~/Desktop/csv/subject1/training/combined/chairStand1_front.csv")

# load combined data: the data sets were created from above code
walk_front <- read.csv("~/Desktop/csv/subject1/training/combined/walk_front.csv")
stand_front <- read.csv("~/Desktop/csv/subject1/training/combined/stand_front.csv")
stairUp_front <- read.csv("~/Desktop/csv/subject1/training/combined/stairUp_front.csv")
stairDown_front <- read.csv("~/Desktop/csv/subject1/training/combined/stairDown_front.csv")
chairStand1_front <- read.csv("~/Desktop/csv/subject1/training/combined/chairStand1_front.csv")
...
write.csv(test_front_step1, "~/Desktop/csv/subject1/test/Step1/combined_front.csv")
test_front_step2 <- combineData(test_acc_front_step2, test_gyro_front_step2)
write.csv(test_front_step2, "~/Desktop/csv/subject1/test/Step2/combined_front.csv")
test_front_step3_fastWalk <- combineData(test_acc_front_step3_fastWalk, test_gyro_front_step3_fastWalk)
write.csv(test_front_step3_fastWalk, "~/Desktop/csv/subject1/test/Step3/fast_walk/combined_front.csv")
test_front_step3_normalWalk <- combineData(test_acc_front_step3_normalWalk, test_gyro_front_step3_normalWalk)
write.csv(test_front_step3_normalWalk, "~/Desktop/csv/subject1/test/Step3/normal_walk/combined_front.csv")
test_front_step3_slowWalk <- combineData(test_acc_front_step3_slowWalk, test_gyro_front_step3_slowWalk)
write.csv(test_front_step3_slowWalk, "~/Desktop/csv/subject1/test/Step3/slow_walk/combined_front.csv")
test_front_step5 <- combineData(test_acc_front_step5, test_gyro_front_step5)
write.csv(test_front_step5, "~/Desktop/csv/subject1/test/Step5/combined_front.csv")
test_front_step6_stairDown <- combineData(test_acc_front_step6_stairDown, test_gyro_front_step6_stairDown)
write.csv(test_front_step6_stairDown, "~/Desktop/csv/subject1/test/Step6/stairDown/combined_front.csv")
test_front_step6_stairUp <- combineData(test_acc_front_step6_stairUp, test_gyro_front_step6_stairUp)
write.csv(test_front_step6_stairUp, "~/Desktop/csv/subject1/test/Step6/stairUp/combined_front.csv")

# the data sets were created by the above codes
test_front_step1 <- read.csv("~/Desktop/csv/subject1/test/Step1/combined_front.csv")
test_front_step2 <- read.csv("~/Desktop/csv/subject1/test/Step2/combined_front.csv")
test_front_step5 <- read.csv("~/Desktop/csv/subject1/test/Step5/combined_front.csv")
test_front_step3_fastWalk <- read.csv("~/Desktop/csv/subject1/test/Step3/fast_walk/combined_front.csv")
test_front_step3_normalWalk <- read.csv("~/Desktop/csv/subject1/test/Step3/normal_walk/combined_front.csv")
test_front_step3_slowWalk <- read.csv("~/Desktop/csv/subject1/test/Step3/slow_walk/combined_front.csv")
test_front_step6_stairDown <- read.csv("~/Desktop/csv/subject1/test/Step6/stairDown/combined_front.csv")
test_front_step6_stairUp <- read.csv("~/Desktop/csv/subject1/test/Step6/stairUp/combined_front.csv")
...
write.csv(combined_result_step1, "~/Desktop/csv/subject1/test/Prediction/Step1/front_pred.csv")
...
write.csv(combined_result_step6_stairUp, "~/Desktop/csv/subject1/test/Prediction/Step6/stairUp/front_pred.csv")
...
write.csv(combined_result_step6_stairDown, "~/Desktop/csv/subject1/test/Prediction/Step6/stairDown/front_pred.csv")
...
write.csv(acc_result_step1, "~/Desktop/csv/subject1/test/Prediction/Step1/acc_front_pred.csv")
...
write.csv(acc_result_step6_stairDown, "~/Desktop/csv/subject1/test/Prediction/Step6/stairDown/acc_front_pred.csv")
...
write.csv(acc_result_step6_stairUp, "~/Desktop/csv/subject1/test/Prediction/Step6/stairUp/acc_front_pred.csv")
...
write.csv(gyro_result_step1, "~/Desktop/csv/subject1/test/Prediction/Step1/gyro_front_pred.csv")
...
write.csv(gyro_result_step6_stairDown, "~/Desktop/csv/subject1/test/Prediction/Step6/stairDown/gyro_front_pred.csv")
...
write.csv(gyro_result_step6_stairUp, "~/Desktop/csv/subject1/test/Prediction/Step6/stairUp/gyro_front_pred.csv")
