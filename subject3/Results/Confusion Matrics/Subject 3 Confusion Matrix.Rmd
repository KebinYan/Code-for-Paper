...
```{r}
combined_result_step1 <- read.csv("~/Desktop/csv/subject3/test/Prediction/Step1/revised_combined_front_pred.csv")
acc_result_step1 <- read.csv("~/Desktop/csv/subject3/test/Prediction/Step1/revised_acc_front_pred.csv")
gyro_result_step1 <- read.csv("~/Desktop/csv/subject3/test/Prediction/Step1/revised_gyro_on_acc_front_pred.csv")

combined_result_step2 <- read.csv("~/Desktop/csv/subject3/test/Prediction/Step2/revised_combined_front_pred.csv")
acc_result_step2 <- read.csv("~/Desktop/csv/subject3/test/Prediction/Step2/revised_acc_front_pred.csv")
gyro_result_step2 <- read.csv("~/Desktop/csv/subject3/test/Prediction/Step2/revised_gyro_on_acc_front_pred.csv")

combined_result_step3_fastWalk <- read.csv("~/Desktop/csv/subject3/test/Prediction/Step3/fast_walk/revised_combined_front_pred_fast.csv")
acc_result_step3_fastWalk <- read.csv("~/Desktop/csv/subject3/test/Prediction/Step3/fast_walk/revised_acc_front_pred_fast.csv")
gyro_result_step3_fastWalk <- read.csv("~/Desktop/csv/subject3/test/Prediction/Step3/fast_walk/revised_gyro_on_acc_front_pred_fast.csv")

combined_result_step3_normalWalk <- read.csv("~/Desktop/csv/subject3/test/Prediction/Step3/normal_walk/revised_combined_front_pred_normal.csv")
acc_result_step3_normalWalk <- read.csv("~/Desktop/csv/subject3/test/Prediction/Step3/normal_walk/revised_acc_front_pred_normal.csv")
gyro_result_step3_normalWalk <- read.csv("~/Desktop/csv/subject3/test/Prediction/Step3/normal_walk/revised_gyro_on_acc_front_pred_normal.csv")

combined_result_step3_slowWalk <- read.csv("~/Desktop/csv/subject3/test/Prediction/Step3/slow_walk/revised_combined_front_pred_slow.csv")
acc_result_step3_slowWalk <- read.csv("~/Desktop/csv/subject3/test/Prediction/Step3/slow_walk/revised_acc_front_pred_slow.csv")
gyro_result_step3_slowWalk <- read.csv("~/Desktop/csv/subject3/test/Prediction/Step3/slow_walk/revised_gyro_on_acc_front_pred_slow.csv")

combined_result_step5 <- read.csv("~/Desktop/csv/subject3/test/Prediction/Step5/revised_combined_front_pred.csv")
acc_result_step5 <- read.csv("~/Desktop/csv/subject3/test/Prediction/Step5/revised_acc_front_pred.csv")
gyro_result_step5 <- read.csv("~/Desktop/csv/subject3/test/Prediction/Step5/revised_gyro_on_acc_front_pred.csv")

combined_result_step6_stairDown <- read.csv("~/Desktop/csv/subject3/test/Prediction/Step6/stairDown/revised_combined_front_pred.csv")
acc_result_step6_stairDown <- read.csv("~/Desktop/csv/subject3/test/Prediction/Step6/stairDown/revised_acc_front_pred.csv")
gyro_result_step6_stairDown <- read.csv("~/Desktop/csv/subject3/test/Prediction/Step6/stairDown/revised_gyro_on_acc_front_pred.csv")

combined_result_step6_stairUp <- read.csv("~/Desktop/csv/subject3/test/Prediction/Step6/stairUp/revised_combined_front_pred.csv")
acc_result_step6_stairUp <- read.csv("~/Desktop/csv/subject3/test/Prediction/Step6/stairUp/revised_acc_front_pred.csv")
gyro_result_step6_stairUp <- read.csv("~/Desktop/csv/subject3/test/Prediction/Step6/stairUp/revised_gyro_on_acc_front_pred.csv")
```
