...
combined_result_step3_fastWalk <- read.csv("~/Desktop/csv/subject2/test/Prediction/Step3/front_pred_fast.csv")
acc_result_step3_fastWalk <- read.csv("~/Desktop/csv/subject2/test/Prediction/Step3/acc_front_pred_fast.csv")
gyro_result_step3_fastWalk <- read.csv("~/Desktop/csv/subject2/test/Prediction/Step3/gyro_front_pred_fast.csv")

combined_result_step3_normalWalk <- read.csv("~/Desktop/csv/subject2/test/Prediction/Step3/front_pred_normal.csv")
acc_result_step3_normalWalk <- read.csv("~/Desktop/csv/subject2/test/Prediction/Step3/acc_front_pred_normal.csv")
gyro_result_step3_normalWalk <- read.csv("~/Desktop/csv/subject2/test/Prediction/Step3/gyro_front_pred_normal.csv")

combined_result_step3_slowWalk <- read.csv("~/Desktop/csv/subject2/test/Prediction/Step3/front_pred_slow.csv")
acc_result_step3_slowWalk <- read.csv("~/Desktop/csv/subject2/test/Prediction/Step3/acc_front_pred_slow.csv")
gyro_result_step3_slowWalk <- read.csv("~/Desktop/csv/subject2/test/Prediction/Step3/gyro_front_pred_slow.csv")
