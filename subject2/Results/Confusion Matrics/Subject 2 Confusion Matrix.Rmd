---
title: "Subject 2 Confusion Matrices"
author: "Kebin Yan"
date: "5/25/2021"
output: pdf_document
---
...
```{r}
combined_result_step1 <- read.csv("~/Desktop/csv/subject2/test/Prediction/Step1/revised_combined_front_pred.csv")
acc_result_step1 <- read.csv("~/Desktop/csv/subject2/test/Prediction/Step1/revised_acc_front_pred.csv")
gyro_result_step1 <- read.csv("~/Desktop/csv/subject2/test/Prediction/Step1/revised_gyro_on_acc_front_pred.csv")

combined_result_step2 <- read.csv("~/Desktop/csv/subject2/test/Prediction/Step2/revised_combined_front_pred.csv")
acc_result_step2 <- read.csv("~/Desktop/csv/subject2/test/Prediction/Step2/revised_acc_front_pred.csv")
gyro_result_step2 <- read.csv("~/Desktop/csv/subject2/test/Prediction/Step2/revised_gyro_on_acc_front_pred.csv")

combined_result_step3_fastWalk <- read.csv("~/Desktop/csv/subject2/test/Prediction/Step3/fast_walk/revised_combined_front_pred_fast.csv")
acc_result_step3_fastWalk <- read.csv("~/Desktop/csv/subject2/test/Prediction/Step3/fast_walk/revised_acc_front_pred_fast.csv")
gyro_result_step3_fastWalk <- read.csv("~/Desktop/csv/subject2/test/Prediction/Step3/fast_walk/revised_gyro_on_acc_front_pred_fast.csv")

combined_result_step3_normalWalk <- read.csv("~/Desktop/csv/subject2/test/Prediction/Step3/normal_walk/revised_combined_front_pred_normal.csv")
acc_result_step3_normalWalk <- read.csv("~/Desktop/csv/subject2/test/Prediction/Step3/normal_walk/revised_acc_front_pred_normal.csv")
gyro_result_step3_normalWalk <- read.csv("~/Desktop/csv/subject2/test/Prediction/Step3/normal_walk/revised_gyro_on_acc_front_pred_normal.csv")

combined_result_step3_slowWalk <- read.csv("~/Desktop/csv/subject2/test/Prediction/Step3/slow_walk/revised_combined_front_pred_slow.csv")
acc_result_step3_slowWalk <- read.csv("~/Desktop/csv/subject2/test/Prediction/Step3/slow_walk/revised_acc_front_pred_slow.csv")
gyro_result_step3_slowWalk <- read.csv("~/Desktop/csv/subject2/test/Prediction/Step3/slow_walk/revised_gyro_on_acc_front_pred_slow.csv")

combined_result_step5 <- read.csv("~/Desktop/csv/subject2/test/Prediction/Step5/revised_combined_front_pred.csv")
acc_result_step5 <- read.csv("~/Desktop/csv/subject2/test/Prediction/Step5/revised_acc_front_pred.csv")
gyro_result_step5 <- read.csv("~/Desktop/csv/subject2/test/Prediction/Step5/revised_gyro_on_acc_front_pred.csv")

combined_result_step6_stairDown <- read.csv("~/Desktop/csv/subject2/test/Prediction/Step6/stairDown/revised_combined_front_pred.csv")
acc_result_step6_stairDown <- read.csv("~/Desktop/csv/subject2/test/Prediction/Step6/stairDown/revised_acc_front_pred.csv")
gyro_result_step6_stairDown <- read.csv("~/Desktop/csv/subject2/test/Prediction/Step6/stairDown/revised_gyro_on_acc_front_pred.csv")

combined_result_step6_stairUp <- read.csv("~/Desktop/csv/subject2/test/Prediction/Step6/stairUp/revised_combined_front_pred.csv")
acc_result_step6_stairUp <- read.csv("~/Desktop/csv/subject2/test/Prediction/Step6/stairUp/revised_acc_front_pred.csv")
gyro_result_step6_stairUp <- read.csv("~/Desktop/csv/subject2/test/Prediction/Step6/stairUp/revised_gyro_on_acc_front_pred.csv")
```
...
pdf(file = "~/Desktop/Confusion Matrix/subject2/step1_acc.pdf")
plotConfusionMatrix(acc_result_step1, Activities, TRUE)
dev.off()

pdf(file = "~/Desktop/Confusion Matrix/subject2/step1_gyro.pdf")
plotConfusionMatrix(gyro_result_step1, Activities, TRUE)
dev.off()

pdf(file = "~/Desktop/Confusion Matrix/subject2/step1_combined.pdf")
...
```{r, warning=FALSE, fig.asp=1.1}
# par(mfrow = c(3,1))
pdf(file = "~/Desktop/Confusion Matrix/subject2/step2_acc.pdf")
plotConfusionMatrix(acc_result_step2, Activities, TRUE)
dev.off()

pdf(file = "~/Desktop/Confusion Matrix/subject2/step2_gyro.pdf")
plotConfusionMatrix(gyro_result_step2, Activities, TRUE)
dev.off()

pdf(file = "~/Desktop/Confusion Matrix/subject2/step2_combined.pdf")
...
```{r, warning=FALSE, fig.asp=1.1}
# par(mfrow = c(3,1))
pdf(file = "~/Desktop/Confusion Matrix/subject2/step3_acc.pdf")
plotConfusionMatrix(acc_result_step3, Activities, TRUE)
dev.off()

pdf(file = "~/Desktop/Confusion Matrix/subject2/step3_gyro.pdf")
plotConfusionMatrix(gyro_result_step3, Activities, TRUE)
dev.off()

pdf(file = "~/Desktop/Confusion Matrix/subject2/step3_combined.pdf")
...
```{r, warning=FALSE, fig.asp=1.1}
# par(mfrow = c(3,1))
pdf(file = "~/Desktop/Confusion Matrix/subject2/step5_acc.pdf")
plotConfusionMatrix(acc_result_step5, Activities, TRUE)
dev.off()

pdf(file = "~/Desktop/Confusion Matrix/subject2/step5_gyro.pdf")
plotConfusionMatrix(gyro_result_step5, Activities, TRUE)
dev.off()

pdf(file = "~/Desktop/Confusion Matrix/subject2/step5_combined.pdf")
...
```{r, warning=FALSE, fig.asp=1.1}
# par(mfrow = c(3,1))
pdf(file = "~/Desktop/Confusion Matrix/subject2/step6_acc.pdf")
plotConfusionMatrix(acc_result_step6, Activities, TRUE)
dev.off()

pdf(file = "~/Desktop/Confusion Matrix/subject2/step6_gyro.pdf")
plotConfusionMatrix(gyro_result_step6, Activities, TRUE)
dev.off()

pdf(file = "~/Desktop/Confusion Matrix/subject2/step6_combined.pdf")
...
```{r, warning=FALSE, fig.asp=1.1}
pdf(file = "~/Desktop/Confusion Matrix/subject2/all_steps_acc.pdf")
plotConfusionMatrix(acc_result_summary, Activities, TRUE)
dev.off()

pdf(file = "~/Desktop/Confusion Matrix/subject2/all_steps_gyro.pdf")
plotConfusionMatrix(gyro_result_summary, Activities, TRUE)
dev.off()

pdf(file = "~/Desktop/Confusion Matrix/subject2/all_steps_combined.pdf")
